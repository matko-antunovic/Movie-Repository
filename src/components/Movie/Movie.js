...
const Movie = ({ movie, directors, actors, loading,movieId,review,similar }) => {
      ...
      {actors ? (
        <div className="rmdb-movie-grid">
          ...
          <div className="rmdb-movie-details__review">
              <div className="rmdb-movie-details__review--text">{review ? limitText(review.content,600) : <Review name={movie.original_title}/>}</div>
            </div>
          </div>
          : null}
          ...
          <div className="rmdb-movie-similar">
            ...
            <div className="rmdb-movie-similar__right-side">
              RIGHT SIDE LALALA ASKDLO DSAKO SADK ODSA ADSK OSA D
            </div>
          </div>
